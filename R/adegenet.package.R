...
#' @method as.data.frame genlight
#' @method as.data.frame genpop
#' @method as.integer SNPbin
#' @method as.lda dapc
#' @method as.list genlight
#' @method as.matrix genpop
#' @method c SNPbin
#' @method cbind SNPbin
#' @method "[" haploGen
#' @method cbind genlight
#' @method rbind genlight
#' @method xvalDapc data.frame
#' @method xvalDapc default
#' @method xvalDapc genind
#' @method xvalDapc genlight
#' @method xvalDapc matrix
#' @method colorplot default
