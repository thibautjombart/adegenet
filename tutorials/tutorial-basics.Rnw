...
barplot(nAll(toto), ylab="Number of alleles",
...
<<>>=
s.label(ca1$li,lab=popNames(obj),sub="CA 1-2",csub=2)
add.scatter.eig(ca1$eig,nf=3,xax=1,yax=2,posi="bottomright")
@

<<>>=
s.label(ca1$li,xax=1,yax=3,lab=popNames(obj),sub="CA 1-3",csub=2)
