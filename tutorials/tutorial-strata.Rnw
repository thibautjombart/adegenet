...
\begin{abstract}
  ...
  \adegenet{} version 2.0-0 from the \textit{poppr} package. Sampling schemes
  are often not constrained to simply one population factor. They can be
  stratified over years, treatments, and geographic locations. The
  \textbf{strata} slot provides a way to store and combine any population strata
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Introduction to strata \{Are you stratified?\}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\label{strata}
...
\begin{tabular}{llll}
 ...
 set & \cmdlink{strata:define:set}{strata} & data frame & new hierarchical levels\\ 
...
\subsubsection{Using a data frame}
...
\subsubsection{Using your input file}
\label{strata:define:combine}

As explained in \ref{strata}, one useful way to define strata for your data is
to concatenate them using `\_' and set that as your population factor in your
original input file. This allows you to carry your strata with the genetic data
even when it's not in R.
...
micdf[1:6, 1:6]                       # Check that the data is correct
...
When we import our data, we have the population factor in the first column and
the genotypes in the other columns. We can import our data this way:
...
We know that we have all of our strata combined into one level. We can split them
by using the command \texttt{splitStrata}.
...
\subsection{Viewing strata}
\label{strata:view}

% If you wanted to view your strata to make sure that you made no spelling
% errors in your population definitions, you can extract the data frame from your
% genind object by using the function \texttt{strata}:
...
\subsection{Manipulating hierarchical levels}
\label{strata:manip}
...
\subsection{Defining populations with strata}
\label{strata:setPop}
